...
})
{
  ...
  // React.useEffect(() => {
  //   uniforms.current.uBaseColor.set(baseColor);
  //   uniforms.current.uBurnColor.set(burnColor).multiplyScalar(burnIntensity);
  //   uniforms.current.uBurnColorEnd.set(burnColorEnd).multiplyScalar(burnIntensity);
  // }, [baseColor, burnColor, burnColorEnd]);
  ...
  const BurnMaterial = shaderMaterial( uniforms.current, vertexShader, fragmentShader )
  extend( { BurnMaterial })
